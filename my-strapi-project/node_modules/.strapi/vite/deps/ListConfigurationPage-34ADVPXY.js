...
`;
var DragButton = at(ActionButton)`
  padding: 0 ${({ theme }) => theme.spaces[3]};
  border-right: 1px solid ${({ theme }) => theme.colors.neutral150};
  cursor: all-scroll;
`;
var FieldContainer = at(T)`
  max-height: 3.2rem;
  cursor: pointer;
`;
var FieldWrapper = at(R)`
  &:last-child {
...
//# sourceMappingURL=ListConfigurationPage-34ADVPXY.js.map
