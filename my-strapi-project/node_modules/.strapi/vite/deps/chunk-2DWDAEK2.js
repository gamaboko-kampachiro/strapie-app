import {
  ...
  StageColumn,
  getDisplayName
} from "./chunk-BIONZXTT.js";
import {
  buildValidParams as buildValidParams2
} from "./chunk-AK5CFNWL.js";
import {
  getStageColorByHex
} from "./chunk-TVZTKJHZ.js";
import {
  LimitsModal
} from "./chunk-4XV7L6O2.js";
import {
...
} from "./chunk-QGQIF2YN.js";
import {
  useTypedSelector
} from "./chunk-YGERFWPT.js";
import {
  ...
  useGetLocalesQuery,
  useGetSettingsQuery
} from "./chunk-Q2KW5QFS.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-OYVOQ5UB.js";
import {
  index
} from "./chunk-KUHEYZ2M.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-46F4RX5H.js";
import {
  useConfig
} from "./chunk-G5RHE5HZ.js";
import {
  AssetSource,
...
import {
  useDocumentActions
} from "./chunk-QRT3VY4P.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-BVLBCZ2J.js";
import {
  renderAdmin
} from "./chunk-65YSNWME.js";
import {
  useAIAvailability
} from "./chunk-44TDZ46T.js";
import {
  useLicenseLimits
} from "./chunk-FLCUBRFR.js";
import {
  Table,
  useTable
} from "./chunk-UCVBB42H.js";
import {
  useField,
  useForm
...
import {
  useRBAC
} from "./chunk-2CQJTEJH.js";
import {
  Form,
  Formik,
  useFormik
} from "./chunk-KD5DCDDD.js";
import {
  create3 as create,
  create4 as create2,
  create6 as create3
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-YTNQ4CFA.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-VFPTKNC4.js").then((mod) => ({
...
// node_modules/@strapi/upload/dist/admin/components/AssetDialog/BrowseStep/BrowseStep.mjs
var TypographyMaxWidth = at(I)`
  max-width: 100%;
`;
var ActionContainer = at(R)`
  svg {
    path {
...
function __variableDynamicImportRuntime3__(path) {
  switch (path) {
    ...
    case "./translations/en.json":
      return import("./en.json-4KPMJ7AX.js");
    case "./translations/es.json":
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => {
        return import("./App-US566GWV.js").then((mod) => ({
          default: mod.Upload
        }));
      },
      position: 4
    ...
    if (window.strapi.future.isEnabled("unstableMediaLibrary")) {
      app.addMenuLink({
        ...
        permissions: PERMISSIONS3.main,
        Component: () => {
          return import("./App-K64IBZ4R.js").then((mod) => ({
    ...
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-PTCWCC3Y.js");
        return {
...
var AITranslationStatusIcon = at(g1)`
  display: flex;
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-VASROPJJ.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-GV57ZRW3.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-GOCDZVYB.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-WPL7MZIH.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-FFQRE7T5.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-H4UHDJTP.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-VW4FOC75.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-OJNRUQOW.js");
          return {
...
//# sourceMappingURL=chunk-2DWDAEK2.js.map
