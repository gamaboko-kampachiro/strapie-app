...
var AccordionRoot = at(Sm.Root)`
  border: 1px solid
    ${({ theme, $error }) => $error ? theme.colors.danger600 : theme.colors.neutral200};
`;
var ContextMenuTrigger = at(Am.Trigger)`
  :hover,
  :focus {
...
var NestedOption = at(Fa)`
  padding-left: ${({ theme }) => theme.spaces[7]};
`;
var PermissionWrapper = at(T)`
  > * {
    flex-grow: 1;
  }
`;
...
var NestedOption2 = at(Fa)`
  padding-left: ${({ theme }) => theme.spaces[7]};
`;
var ContentTypeTakeNotice = at(I)`
  font-style: italic;
`;
...
//# sourceMappingURL=id-IOHJOLWO.js.map
